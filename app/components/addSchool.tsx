...
export default function AddSchool() {
  ...
  return <div className="  flex flex-col px-6 justify-center  md:items-center p-4  ">
    <div className=" rounded-lg shadow-2xl bg-white ">
      ...
      <form className="flex flex-col p-8 w-[500px ] md:w-[620px] space-y-4 " onSubmit={handleSubmit(addData)}>

        <div className="flex flex-col space-y-1">
          <label className="text-xl text-gray-600">School Name</label>
          <input type="text" {...register("name", { required: "Name is required!" })} placeholder="Enter Name " className="p-2 focus:outline-purple-500 border border-gray-400 rounded" />
        ...
        <div className="flex flex-col space-y-1">
          ...
          <input type="text" {...register("city", { required: "City is Required!" })} placeholder="New York " className="p-2 focus:outline-purple-500 border border-gray-400 rounded" />
          {errors.city && <p className="text-red-500 text-sm">{errors.city.message}</p>}
        </div>
        <div className="flex flex-col space-y-1">
          <label className="text-xl text-gray-600">State</label>
          <input type="text" {...register("state", { required: "State is Required!" })} placeholder="California " className="p-2 focus:outline-purple-500 border border-gray-400 rounded" />
        ...
        <div className="flex flex-col space-y-1">
          ...
          })} placeholder="9265365352 " className="p-2 focus:outline-purple-500 border border-gray-400 rounded" />
          {errors.contact && <p className="text-red-500 text-sm">{errors.contact.message}</p>}
        </div>
        <div className="flex flex-col space-y-1">
          <label className="text-xl text-gray-600">Email</label>
          <input type="text" {...register("email", { required: "Email is Required!", pattern: /^\S+@\S+$/i })} placeholder="nyu.school@gmail.com " className="p-2 focus:outline-purple-500 border border-gray-400 rounded" />
        ...
        <button type="submit" className="px-6 py-2 rounded-xl bg-purple-500 text-white text-lg font-semibold hover:bg-purple-600 cursor-pointer duration-200 transition">Add</button>
